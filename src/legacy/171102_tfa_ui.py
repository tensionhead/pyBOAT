...
class DataViewer(QWidget):
    ...
    def __init__(self):
        ...
        #self.initUI()
    def initUI(self):
        self.plotWindow = TimeSeriesWindow(self)
...
class Detrender(QWidget):
    ...
    def __init__(self):
        ...
        #self.initUI()
    def initUI(self):
        self.plotWindow = TimeSeriesWindow(parent=self)
        print(self.plotWindow.sizeHint())
        self.plotWindow_signal = TimeSeriesWindow(self)
        print (type(self.plotWindow))
...
class MyMplCanvas(FigureCanvas):
    ...
    def update(self, tvec, signal, clear = True):
        self.signal= signal
        wl.plot_signal_trend(self.siganl,self.signal,1)
        '''if DEBUG:
