...
class WAnalyzer:
    ...
    def __init__(self, periods, dt, p_max=None, time_unit_label="a.u.", M=None):
    ...
    def compute_spectrum(
        self, raw_signal, T_c=None, window_size=None, do_plot=True, draw_coi=False
    ):
    ...
    def get_sign_maxRidge(
        self, empirical_background, confidence=core.chi2_95, smoothing_wsize=None
    ):
        ...
        spectrum_bool = core.get_significant_regions(self.modulus, empirical_background)
    ...
    def get_envelope(self, signal, window_size, SGsmooth=True):
        ...
        envelope = core.sliding_window_amplitude(
            signal, window_size, dt=self.dt, SGsmooth=SGsmooth
        )
    ...
    def normalize_amplitude(self, signal, window_size):
        ...
        ANsignal = core.normalize_with_envelope(signal, window_size, dt=self.dt)
    ...
    def plot_readout(self, draw_coi=False, num=None):
        ...
        pl.plot_readout(
            self.ridge_data, time_unit=self.time_unit_label, draw_coi=draw_coi
        )

    def draw_confidence_from_bg(
        self, empirical_background, confidence=core.chi2_95, **pkwargs
    ):
        ...
        **pkwargs : additional plotting options passed to
        ...
        default_style = {"linewidths": 1.4, "colors": "orange", "alpha": 0.8}

        # update with user arguments
        style_dic = dict(default_style, **pkwargs)

        CS = self.ax_spec.contour(x, y, scaled_mod, levels=[confidence], **style_dic)
