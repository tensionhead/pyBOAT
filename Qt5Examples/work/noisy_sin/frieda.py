...
class ApplicationWindow(QMainWindow):
    def __init__(self, amp, per, sigma):
    ...
    def initUI(self):
        ...
        m = PlotCanvas(self, self.amp, self.per, self.sigma)
        m.move(0,0)
        self.show()

class PlotCanvas(FigureCanvas):
    def __init__(self, amp, per, sigma, parent=None, width=5, height=4, dpi=100):
    ...
    def plot(self):
        ...
        s=self.amp*np.sin(2*np.pi/self.per*t)+noise
        self.axes.plot(t,s)
