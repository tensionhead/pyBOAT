...
class WaveletAnalyzer(QWidget):
    ...
    def initUI(self, position):
        ...
        ## Add tabs
        tabs.addTab(tab1,'Trace maxima')
        tabs.addTab(tab2,'Simulated annealing')
        ...
        ridgebutton_h = QHBoxLayout()
        ridgebutton_h.addWidget(ridgeButton)
        #buttons_hbox.addWidget(ridgeButton2)
        #buttons_hbox.addWidget(saveButton)
        ridgebutton_h.addStretch(0)
        ...
        tab1.ridge_opt_box.addRow(ridgebutton_h)
        ...
        main_layout.addWidget(table_widget,6,0)
        main_layout.addLayout(savebutton_h,7,0)
